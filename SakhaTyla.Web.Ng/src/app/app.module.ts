  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      // ADD ROUTES HERE
      {
        ...
        loadChildren: () => import('./comment/comment-routed.module').then(m => m.CommentRoutedModule)
      },
      {
        path: 'book-authorship',
        canActivate: [AuthorizeGuard],
        loadChildren: () => import('./book-authorship/book-authorship-routed.module').then(m => m.BookAuthorshipRoutedModule)
      },
      {
        path: 'book-author',
        canActivate: [AuthorizeGuard],
        loadChildren: () => import('./book-author/book-author-routed.module').then(m => m.BookAuthorRoutedModule)
      },
      {
        path: 'book-label',
        canActivate: [AuthorizeGuard],
      ...
      },
      {
        path: 'book',
        canActivate: [AuthorizeGuard],
        loadChildren: () => import('./book/book-routed.module').then(m => m.BookRoutedModule)
      },
      {
        path: 'menu-item',
        canActivate: [AuthorizeGuard],
        loadChildren: () => import('./menu-item/menu-item-routed.module').then(m => m.MenuItemRoutedModule)
      },
      {
        path: 'menu',
        canActivate: [AuthorizeGuard],
        loadChildren: () => import('./menu/menu-routed.module').then(m => m.MenuRoutedModule)
      },
      {
        path: 'widget',
        canActivate: [AuthorizeGuard],
