...
@Component({
    ...
    providers: [
        { provide: MatFormFieldControl, useExisting: RouteEditComponent }
    ]
})
export class RouteEditComponent implements ControlValueAccessor, MatFormFieldControl<string>, OnDestroy, DoCheck {
    ...
    id = `route-edit-${RouteEditComponent.nextId++}`;
    describedBy = '';
